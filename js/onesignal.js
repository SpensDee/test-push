  ...
  (i.amdD = function () {
    ...
    (() => {
        ...
        subscribeSafariPromptPermission() {
          return e(this, void 0, void 0, function* () {
            ...
            return this.safariPermissionPromptFailed
              ...
              : e(
                  `${a.getOneSignalApiUrl().toString()}/safari/apps/${
                    this.config.appId
                  }`
                );
          });
      ...
      class Mt {
        ...
        click(t, i) {
          return e(this, void 0, void 0, function* () {
            return yield this.sender.send(new At(t, i));
          });
        }
        willDisplay(t, i) {
          return e(this, void 0, void 0, function* () {
            return yield this.sender.send(new Dt(t, i));
          });
        }
        dismiss(t, i) {
          return e(this, void 0, void 0, function* () {
      ...
      class Rt {
        ...
        static run() {
          self.addEventListener("activate", Rt.onServiceWorkerActivated),
            ...
            self.addEventListener("notificationclose", (e) =>
              e.waitUntil(Rt.onNotificationClosed(e))
            ),
          ...
          Rt.workerMessenger.on(c.WorkerVersion, (e) => {
            ...
            Rt.workerMessenger.on(c.AmpSubscriptionState, (t) =>
              e(this, void 0, void 0, function* () {
                ...
                } else yield Rt.workerMessenger.broadcast(c.AmpSubscriptionState, !1);
              })
            ),
                          ...
                          ((t) =>
                            e(this, void 0, void 0, function* () {
                              ...
                              yield Rt.workerMessenger
                                ...
                                .catch((e) => J.error(e));
                              const i = yield Rt.getPushSubscriptionId();
                              return (
        ...
        static onNotificationClosed(t) {
          return e(this, void 0, void 0, function* () {
            J.debug(
              `Called onNotificationClosed(${JSON.stringify(t, null, 4)}):`,
              t
            );
            ...
            Rt.workerMessenger
              ...
              .catch((e) => J.error(e));
            const i = yield Rt.getPushSubscriptionId();
            Rt.webhookNotificationEventSender.dismiss(e, i);
          });
        }
        ...
        static sendConvertedAPIRequests(t, i, n, o) {
          return e(this, void 0, void 0, function* () {
            ...
            t
              ...
              yield Rt.webhookNotificationEventSender.click(n, i),
              s && (yield s);
          });
        }
        static openUrl(t) {
